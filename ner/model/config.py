...
tf.app.flags.DEFINE_string("src_file", 'words.txt', "Training data.")
tf.app.flags.DEFINE_string("tgt_file", 'sign.txt', "labels.")
# 希望做命名识别的数据
tf.app.flags.DEFINE_string("pred_file", 'predict.txt', "test data.")
tf.app.flags.DEFINE_string("src_vocab_file", 'source.txt', "source vocabulary.")
tf.app.flags.DEFINE_string("tgt_vocab_file", 'target.txt', "targets.")
tf.app.flags.DEFINE_string("word_embedding_file", 'word2vec.txt', "extra word embeddings.")
